...
ibrun /work/06640/wrogers/mysharedirectory/qe-edited/pwcond-scattering/documentation/qe-build/q-e-qe-6.4.1/bin/pwcond.x -input input.spin_up.cond
#ibrun /work/06640/wrogers/mysharedirectory/qe-edited/qe-newcompile/qe-5compile/q-e-qe-6.4.1/bin/pwcond.x -input input.spin_up.cond
