...
ibrun /work/06640/wrogers/mysharedirectory/qe-edited/q-e-gpu-qe-gpu-6.4.1a1/bin/pw.x -input input.lead_down.vcmd
ibrun /work/06640/wrogers/mysharedirectory/qe-edited/q-e-gpu-qe-gpu-6.4.1a1/bin/pw.x -input input.lead_up.vcmd
ibrun /work/06640/wrogers/mysharedirectory/qe-edited/q-e-gpu-qe-gpu-6.4.1a1/bin/pw.x -input input.barrier.vcmd
# post processing
