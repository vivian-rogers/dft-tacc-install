#!/bin/bash 
#SBATCH -J qe-workfunct                               # define the job name
...
#cd ./scratch
/work/06640/wrogers/mysharedirectory/qe-edited/q-e-qe-6.4.1/bin/average.x < ./input.avg > ./average.out     # do scf calculations
#cd ../
